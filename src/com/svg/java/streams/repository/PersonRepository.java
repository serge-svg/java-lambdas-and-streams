...
public class PersonRepository {
    ...
    static {
        ...
        personList.add(new Person("name3", "surname4", 82, Arrays.asList(new Sport("Cycling", 3), new Sport("Running", 2))));
        personList.add(new Person("name4", "surname1", 22, Arrays.asList(new Sport("Running", 2))));
    }
