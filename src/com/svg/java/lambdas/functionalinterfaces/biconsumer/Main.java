...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BiConsumer<Person, Person> biConsumerNames = (p1, p2) -> System.out.printf("Person: %s %s", p1.getName(), p2.getName());
    ...
    private static void printMapPerson(String key, Person person) {
        System.out.printf("Name is %s and surname is %s %n", key, person.getSurname());
    }
